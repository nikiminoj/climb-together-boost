...
/**
 * Retrieves badges earned by a specific user, including badge details and the date earned.
 *
 * @param userId - The unique identifier of the user whose badges are being fetched
 * @returns An array of user badge records with associated badge information; returns an empty array if an error occurs
 */
 ...
 * @returns `true` if the upvote was registered successfully, or `false` if an error occurred
 */
